package cn.lemonnetwork.lemonbedwars.Game.Arena.SpecialMode;
...
public class RushMode {
    ...
    public static Plugin plugin = LemonBedWars.getPlugin(LemonBedWars.class);
    public static FileConfiguration config = plugin.getConfig();

    public static void start() {

        for (Player player : Bukkit.getOnlinePlayers()) {
            LemonBedWars.onSpeed.put(player.getName(), true);
        }
    ...
    public static void placersn(Team team, Location location) {
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(TOZ, TOY, AXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(BZZZ, TOY, BXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(ZZZZ, TOY, XXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(CZZZ, TOY, CXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(DZZZ, TOY, DXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(EZZZ, TOY, EXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(FZZZ, TOY, FXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(GZZZ, TOY, GXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(HZZZ, TOY, HXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(IZZZ, TOY, IXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(JZZZ, TOY, JXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(KZZZ, TOY, KXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(LZZZ, TOY, LXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(MZZZ, TOY, MXXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(TOZ, OYYY, AXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(BZZ, OYYY, BXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(CZZ, OYYY, CXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(CZZ, OYYY, DXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(EZZ, OYYY, EXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(FZZ, OYYY, FXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(GZZ, OYYY, GXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(HZZ, OYYY, HXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(HZZ, OYYY, IXX).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(TOZ, NYYY, TOX).getLocation());
        bed.getWorld().getBlockAt(TOZ, NYYY, FX).setType(Material.STAINED_GLASS);
        bed.getWorld().getBlockAt(TOZ, NYYY, FX).setData((byte) color);
        LemonBedWars.changedBlocks.add(bed.getWorld().getBlockAt(TOZ, NYYY, FX).getLocation());
    }
    ...
    public static void placerwe(Team team, Location location) {
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(AX, TOY, TOZ).getLocation());
        bed1.getWorld().getBlockAt(BX, TOY, BZ).setType(Material.WOOD);
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(BX, TOY, BZ).getLocation());
        bed1.getWorld().getBlockAt(CX, TOY, BZ).setType(Material.WOOD);
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(CX, TOY, BZ).getLocation());
        bed1.getWorld().getBlockAt(DX, TOY, DZ).setType(Material.WOOD);
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(DX, TOY, DZ).getLocation());
        bed1.getWorld().getBlockAt(EX, TOY, EZ).setType(Material.WOOD);
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(EX, TOY, EZ).getLocation());
        bed1.getWorld().getBlockAt(FX, TOY, EZ).setType(Material.WOOD);
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(FX, TOY, EZ).getLocation());
        bed1.getWorld().getBlockAt(TOX, BDY, TOZ).setType(Material.WOOD);
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(TOX, BDY, TOZ).getLocation());
        bed1.getWorld().getBlockAt(FX, BDY, TOZ).setType(Material.WOOD);
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(FX, BDY, TOZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(AXX, TOY, TOZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(BXX, TOY, BZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(CXX, TOY, CZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(DXX, TOY, CZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(EXX, TOY, EZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(FXX, TOY, FZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(GXX, TOY, GZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(HXX, TOY, HZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(IXX, TOY, HZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(TOX, KYY, TOZ).getLocation());
        bed1.getWorld().getBlockAt(FX, KYY, TOZ).setType(Material.WOOL);
        bed1.getWorld().getBlockAt(FX, KYY, TOZ).setData((byte)(int)woolcolor);
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(FX, KYY, TOZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(AXXX, TOY, TOZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(BXXX, TOY, BZZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(XXXX, TOY, ZZZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(CXXX, TOY, CZZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(DXXX, TOY, DZZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(EXXX, TOY, EZZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(FXXX, TOY, FZZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(GXXX, TOY, GZZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(HXXX, TOY, HZZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(IXXX, TOY, IZZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(JXXX, TOY, JZZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(KXXX, TOY, KZZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(LXXX, TOY, LZZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(MXXX, TOY, MZZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(AXX, OYYY, TOZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(BXX, OYYY, BZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(CXX, OYYY, CZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(DXX, OYYY, CZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(EXX, OYYY, EZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(FXX, OYYY, FZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(GXX, OYYY, GZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(HXX, OYYY, HZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(IXX, OYYY, HZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(JXX, OYYY, JZZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(AX, PYYY, TOZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(BX, PYYY, BZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(CX, PYYY, BZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(DX, PYYY, DZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(EX, PYYY, EZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(FX, PYYY, EZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(TOX, NYYY, TOZ).getLocation());
        ...
        LemonBedWars.changedBlocks.add(bed1.getWorld().getBlockAt(FX, NYYY, TOZ).getLocation());
    }
}
