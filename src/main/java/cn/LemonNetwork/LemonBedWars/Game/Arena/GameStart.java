...
import cn.lemonnetwork.lemonbedwars.API.Event.GameStartEvent;
import cn.lemonnetwork.lemonbedwars.Game.Arena.Menu.Selector;
import cn.lemonnetwork.lemonbedwars.Game.Arena.SpecialMode.RushMode;
...
public class GameStart {
    ...
    public static void start() {
        ...
        LemonBedWars.state = "Play"; // 设置当前游戏状态
        ...
        for (Player forplayer : playerList) {
            ...
            LemonBedWars.ShopCd.put(forplayer.getName(), 0);
            LemonBedWars.Fireballcooldown.put(forplayer, 0);

            LemonBedWars.kill.put(forplayer.getName(), 0);
            LemonBedWars.finalkill.put(forplayer.getName(), 0);
            LemonBedWars.deaths.put(forplayer.getName(), 0);
            LemonBedWars.finaldeaths.put(forplayer.getName(), 0);
            LemonBedWars.breakbed.put(forplayer.getName(), 0);
            LemonBedWars.shoutcd.put(forplayer.getName(), 0);
            LemonBedWars.xp.put(forplayer.getName(), 0);
            LemonBedWars.coins.put(forplayer.getName(), 0);
            LemonBedWars.shears.put(forplayer.getName(), false);
            LemonBedWars.axe.put(forplayer.getName(), 0);
            LemonBedWars.pickaxe.put(forplayer.getName(), 0);
            forplayer.setNoDamageTicks(120);
            LemonBedWars.playeradditem.put(forplayer.getName(), "空");
            ...
            forplayer.setPlayerListName(getScoreboard().getEntryTeam(forplayer.getName()).getPrefix() + forplayer.getName());
            forplayer.setDisplayName(getScoreboard().getEntryTeam(forplayer.getName()).getPrefix() + forplayer.getName());
            if (PlayerDataManage.getPlayerLang(forplayer).equalsIgnoreCase("zhcn")) {
                TAB.set(forplayer, "     §b§l你正在§e§l" + LemonBedWars.serverip + "§b§l上进行游戏\n", "\n§b击杀数: §e" + LemonBedWars.kill.get(forplayer.getName()) + " §b最终击杀数: §e" + LemonBedWars.finalkill.get(forplayer.getName()) + " §b破坏床数: §e" + LemonBedWars.breakbed.get(forplayer.getName()) + "\n\n     §a§lRank以及更多！§c§l请访问Store." + LemonBedWars.serverip);
            } else {
                TAB.set(forplayer, "     §b§lYou are playing on §e§l" + LemonBedWars.serverip + "\n", "\n§bKills: §e" + LemonBedWars.kill.get(forplayer.getName()) + " §bFlial Kills: §e" + LemonBedWars.finalkill.get(forplayer.getName()) + " §bDestroyed Beds: §e" + LemonBedWars.breakbed.get(forplayer.getName()) + "\n\n     §a§lRank & More! §c§lStore." + LemonBedWars.serverip);
            }
        ...
        }.runTaskTimer(JavaPlugin.getPlugin(LemonBedWars.class), 5000, 5000);
        new BukkitRunnable() {
        ...
        }.runTaskTimer(JavaPlugin.getPlugin(LemonBedWars.class), 200 + new Random().nextInt(3000), new Random().nextInt(6500));
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            for (Team t : CreateTeam.teamList) {
                if (!t.getDisplayName().equalsIgnoreCase("yes")) {
                    ...
                    LemonBedWars.sharp.put(t.getName(), false);
                    LemonBedWars.Dragon.put(t.getName(), false);
                    LemonBedWars.protectUpgrade.put(t.getName(), 0);
                    LemonBedWars.HasteUpgrade.put(t.getName(), 0);
                    LemonBedWars.Trap.put(t.getName(), new ArrayList<>());
                }
            }
        }
    }
    public static void ShowScoreBoard(Player player) {
        ...
        Bukkit.getServer().getScheduler().scheduleSyncRepeatingTask(plugin, () -> {
            ...
            Board.add("§b ");
            int fen = LemonBedWars.Listenertime / 60;
            int miao = fen * 60;
            miao = LemonBedWars.Listenertime - miao;
            ...
            Board.add("§f" + LemonBedWars.Listenername + " - §a" + fenstr + ":" + miaostr);
            Board.add("§1 ");
            for (Team team : CreateTeam.teamList) {
            ...
            if (Objects.equals(config.getString("Map.ModeType"), "4v4v4v4") && Objects.equals(config.getString("Map.ModeType"), "3v3v3v3")) {//判断是否为4v4v4v4
                ...
                if (PlayerDataManage.getPlayerLang(player).equalsIgnoreCase("zhcn")) {
                    ...
                    Board.add("§f击杀数: §a" + LemonBedWars.kill.get(player.getName()));
                    Board.add("§f最终击杀数: §a" + LemonBedWars.finalkill.get(player.getName()));
                    Board.add("§f破坏床数: §a" + LemonBedWars.breakbed.get(player.getName()));
                } else if (PlayerDataManage.getPlayerLang(player).equalsIgnoreCase("en")){
                    Board.add("§fKills: §a" + LemonBedWars.kill.get(player.getName()));
                    Board.add("§fFinal Kills: §a" + LemonBedWars.finalkill.get(player.getName()));
                    Board.add("§fBeds Broken: §a" + LemonBedWars.breakbed.get(player.getName()));
                }
            }
            ...
            if (PlayerDataManage.getPlayerLang(player).equalsIgnoreCase("en")) {
                ...
                Board.add("§f ");
                Board.add("§e" + LemonBedWars.serverip);
