...
public class Game {
    ...
    public static ItemStack getSkull(Player player){
        ...
        skullmeta.setDisplayName(PlayerDataManage.getPlayerPrefix(player) + player.getName());
        ...
        LemonBedWars.getPlugin(LemonBedWars.class).getLogger().info("实例化SKULL:"+player.getName());
        return itemStack;
    }
