    ...
    public void onThrowEgg(ProjectileLaunchEvent e) {
        ...
        if (p instanceof Egg) {
            ...
            if (source instanceof Player) {
                    ...
                    public void run() {
                        if (!p.isDead()) {
                            ...
                            if (a != null) {
                                ...
                                BedWars.changedBlocks.add(a.getLocation());
                            }
                            if (b != null) {
                                b.setType(Material.WOOL);
                                b.setData((byte) woolcolor);
                                BedWars.changedBlocks.add(b.getLocation());
                            }
                            if (c != null) {
                                c.setType(Material.WOOL);
                                c.setData((byte) woolcolor);
                                BedWars.changedBlocks.add(c.getLocation());
                            }
                            if (d != null) {
                                d.setType(Material.WOOL);
                                d.setData((byte) woolcolor);
                                BedWars.changedBlocks.add(d.getLocation());
                            }
                ...
                }.runTaskTimer(BedWars.getPlugin(BedWars.class), 5L, 1L);
            }
        }
