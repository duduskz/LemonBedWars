        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                for (Player player : Bukkit.getOnlinePlayers()) {
                    ArrayList<Integer> hologram = Hologram.createHologram(player, new ArrayList<>(lines), armorStand.getWorld().getName()+","+location.getX()+","+(location.getY() + 1.5)+","+location.getZ(), 0.3);
